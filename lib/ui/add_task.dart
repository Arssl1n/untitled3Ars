...
import 'package:untitled3/helpers/app_constants.dart';
import 'package:untitled3/helpers/layout_helper.dart';
import 'package:untitled3/helpers/text_styles.dart';
import 'package:untitled3/model/hive%20/label.dart';
import 'package:untitled3/model/hive%20/task.dart';
import 'package:untitled3/model/task_controller.dart';
import 'package:untitled3/ui/home_page.dart';
import 'package:untitled3/ui/widgets/calender_view.dart';
import 'package:untitled3/ui/widgets/custom_textfield.dart';
import 'package:untitled3/ui/widgets/label_widget.dart';
import 'package:untitled3/ui/widgets/material_button.dart';
import 'package:untitled3/ui/widgets/ui_helpers.dart';
...
class AddTaskPage extends StatelessWidget {
                  ...
                  builder: (controller) {
                    return Column(
                      ...
                      children: [
                        ...
                        buildFieldTItle(title: "PENGINGAT"),
                        CustomTextField(
                          controller: taskController.taskNameController,
                          hintText: "Tulis Nama Pengingat",
                          maxLines: 1,
                        ),
                        const SizedBox(height: 15),
                        buildFieldTItle(title: "TANGGAL"),
                        InkWell(
                          onTap: () {
                          ...
                          child: Obx(() {
                            return TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  labelText: DateFormat("MMM dd, yyyy").format(controller.selectedDate.value),
                                  labelStyle: medTxt,
                                  hintStyle: medTxt.copyWith(color: Colors.black54),
                                  disabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: AppConstants.fontTitleColor)),
                                  suffixIcon: Icon(
                        ...
                        const SizedBox(height: 15),
                        buildFieldTItle(title: "DESKRIPSI"),
                        CustomTextField(
                              ...
                              return InkWell(
                                ...
                                onTap: () {
                                  if (taskController.selectedLabelList[index]) {
                                    taskController.updateSelectedList(index, false);
                                  } else {
                                    taskController.updateSelectedList(index, true);
                                    taskController.label = LayoutHelper.instance.labelList.get(index).name;
                                  }
                                },
                                child: Container(
                                  ...
                                  child: ColorFiltered(
                                    colorFilter: ColorFilter.mode(
                                      taskController.selectedLabelList[index] ? Colors.white : Colors.transparent,
                                      BlendMode.saturation,
                                    ),
                                    child: LabelWidget(
                                      label: LayoutHelper.instance.labelList.get(index).name,
                                      color: LayoutHelper.instance.labelList.get(index).color,
                                    ),
                                  ),
                                ),
                              );
                            ...
                            if (value) {
                              ...
                              Timer(Duration(seconds: 3), () {
                                ...
                                Task task = Task(
                                  ...
                                  description: taskController.taskDescriptionController.text,
                                ...
                                Get.off(HomePage()).then((value) => showSnackbar("Sukses", "Pengingat berhasil dibuat."));
                              });
                            } else {}
                          },
                        ),
        ...
        children: [
          Flexible(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                buildFieldTItle(title: "DIMULAI"),
                Material(
                  color: Colors.transparent,
                  child: InkWell(
                    highlightColor: AppConstants.fontTitleColor.withOpacity(0.2),
                    onTap: () {
                      showTimerDialog(
                        context: context,
                        isStart: true,
                    ...
                    child: Container(margin: const EdgeInsets.only(right: 5), child: buildTimerField(controller.selectedStartTime.value)),
                  ),
                ),
              ],
            ),
          ...
          Flexible(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  buildFieldTItle(title: "BERAKHIR"),
                  Material(
                    color: Colors.transparent,
                    child: InkWell(
                      highlightColor: AppConstants.fontTitleColor.withOpacity(0.2),
                      ...
                      child: Container(margin: const EdgeInsets.only(left: 5), child: buildTimerField(controller.selectedEndTime.value)),
                    ),
                  ),
                ],
              )),
  ...
  void showTimerDialog({BuildContext context, bool isStart, DateTime initalTime}) {
    Get.dialog(
      Scaffold(
                ...
                Flexible(
                  ...
                  child: CupertinoDatePicker(
                    ...
                    onDateTimeChanged: (DateTime newDateTime) {
                      isStart ? taskController.selectedStartTime.value = newDateTime : taskController.selectedEndTime.value = newDateTime;
                    },
                    use24hFormat: false,
                    minuteInterval: 1,
                  ),
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            if (isStart) {
                              if (taskController.selectedStartTime.value == null) {
                                taskController.selectedStartTime.value = DateTime.now();
                              }
                            } else {
                              if (taskController.selectedEndTime.value == null) {
                                taskController.selectedEndTime.value = DateTime.now();
                              }
                            }
                            Navigator.pop(context);
                          },
  ...
  bool doValidaition() {
    if (taskController.taskNameController.text.isEmpty) {
      showSnackbar("Gagal", "Silahkan tulis nama pengingat terlebih dahulu..");
      return false;
    } else if (taskController.taskDescriptionController.text.isEmpty) {
      showSnackbar("Gagal", "Silahkan tulis deskripsi pengingat terlebih dahulu.");
      return false;
    } else if (taskController.label == null) {
      showSnackbar("Gagal", "Silahkan pilih label pengingat.");
      return false;
    }
    return true;
  }
